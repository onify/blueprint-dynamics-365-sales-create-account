...
![Test suite](https://github.com/onify/blueprint-dynamics-365-sales-create-account/workflows/Test%20suite/badge.svg)
...
In this Blueprint we create an account using REST-API integration.

![Onify Blueprint: Create account in Dynamics 365 Sales](blueprint.jpg "Blueprint")
